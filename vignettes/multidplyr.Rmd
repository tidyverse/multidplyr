...
*   Typically, you'll want to avoid loading all the data into memory on one
    instance. Instead, if possible, a better approach is to load the different
    data on each node. If you were reading in many csv files, you code might 
